                ...
                <div className="flex flex-col items-center justify-center shrink w-full">
                  ...
                  <div className="mt-2 text-center w-full">
                    <p className="text-sm text-gray-500 break-all">
                      00020126580014br.gov.bcb.pix0136382f5525-bc1d-4588-94d3-2765cccd2c3c520400005303986540515.005802BR5924Marcone
                      Verissimo da
                      Sil6006Brasil62290525202406081512QM95ABRUPIYPU63048DCA
                    </p>
                  </div>
                </div>
              </div>
